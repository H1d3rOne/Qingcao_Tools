...
from ..cookie_store import get_quark_cookie_file, load_quark_cookie_payload, save_quark_cookie_string
...
class SimpleLogin:
    ...
    def __init__(self):
        ...
        self.cookies_file = get_quark_cookie_file(self.config_dir)
    ...
    def load_saved_cookies(self) -> Optional[str]:
        ...
        try:
            if not self.cookies_file.exists():
                payload = load_quark_cookie_payload(config_dir=self.config_dir)
            else:
