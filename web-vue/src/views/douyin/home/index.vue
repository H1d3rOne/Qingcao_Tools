...
.card {
  ...
  border: 2px solid rgba(var(--app-border-strong-rgb), 0.75);
  border-radius: 16px;
...
.card-header {
  padding: 0 0 16px 0;
  margin-bottom: 16px;
  border-bottom: 1.5px solid rgba(var(--app-border-strong-rgb), 0.5);
}
...
.stat-row {
  ...
  border: 1.5px solid rgba(var(--app-border-strong-rgb), 0.5);
}
